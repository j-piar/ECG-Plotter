// XGraphLabel.h: Schnittstelle f? die Klasse CXGraphLabel.
//
//////////////////////////////////////////////////////////////////////
...
protected:
	virtual void Draw(Graphics &graphics);	// GDI [9/27/2013 ChoiJunHyeok]
	...
	UINT     m_nAlignment;
	int      m_nCurve;
	UINT	 m_nGroupNum;	// 소속 그룹 번호 [10/24/2013 ChoiJunHyeok]


	

public:
	UINT GetGroupNum() const { return m_nGroupNum; }
	void SetGroupNum(UINT _GroupNum) { m_nGroupNum = _GroupNum; }
