...
void CLabelDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_BORDER, m_chkBorder);
	DDX_Control(pDX, IDC_TRANSPARENT, m_chkTransparent);
	DDX_Control(pDX, IDC_CBALIGNMENT, m_cboAlignment);
	DDX_Control(pDX, IDC_CURVE, m_cboCurve);
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen f? Nachrichten CLabelDlg 
...
BOOL CLabelDlg::OnInitDialog() 
{
	...
	m_btnFont.SetTheme(xtpControlThemeOfficeXP);
	m_cboCurve.SetTheme(xtpControlThemeOfficeXP);
	m_chkBorder.SetTheme(xtpControlThemeOfficeXP);
	m_chkTransparent.SetTheme(xtpControlThemeOfficeXP);
	m_cboAlignment.SetTheme(xtpControlThemeOfficeXP);
