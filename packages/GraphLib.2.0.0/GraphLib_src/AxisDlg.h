...
// Dialogfelddaten
	...
	CXTPSpinButtonCtrl	m_SpinArcSize;
	CXTPSpinButtonCtrl	m_SpinTickSize;

	CXTPSpinButtonCtrl	m_SpinPrecision;
	...
	CXTPEdit			m_edtName;
	CXTPButton			m_chkAutoScale;
	CXTPEdit			m_edtMin;
	CXTPEdit			m_edtMax;
	CXTPButton			m_chkShowGrid;
	CXTPButton			m_chkTimeAxis;
	CXTPButton			m_chkVisible;
	CXTPEdit			m_edtPrecision;
	CXTPEdit			m_edtArcSize;
	CXTPEdit			m_edtTickSize;
	CXTPEdit			m_edtMarkerSize;
	CXTPEdit			m_edtStep;
	CXTPButton			m_chkShowMarker;
	CXTPComboBox		m_cboPlacement;
	CXTPComboBox		m_cboGridType;
	CXTPEdit			m_cboTimeStepType;
	CXTPEdit			m_cboTimeStep;

	CXTPButton			m_btnFont1;
	CXTPButton			m_btnFont2;
