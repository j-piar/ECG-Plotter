...
void CAxisDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CBAUTOSCALE, m_chkAutoScale);
	DDX_Control(pDX, IDC_MIN, m_edtMin);
	DDX_Control(pDX, IDC_MAX, m_edtMax);
	DDX_Control(pDX, IDC_CBGRID, m_chkShowGrid);
	DDX_Control(pDX, IDC_CBVISIBLE, m_chkVisible);
	DDX_Control(pDX, IDC_CBTIMEAXIS, m_chkTimeAxis);
	DDX_Control(pDX, IDC_PRECISION, m_edtPrecision);
	DDX_Control(pDX, IDC_ARCSIZE, m_edtArcSize);
	DDX_Control(pDX, IDC_MARKERSIZE, m_edtMarkerSize);
	DDX_Control(pDX, IDC_STEP, m_edtStep);
	DDX_Control(pDX, IDC_CBSHOWMARKERS, m_chkShowMarker);
	DDX_Control(pDX, IDC_PLACEMENT, m_cboPlacement);
	DDX_Control(pDX, IDC_CBGRIDTYPE, m_cboGridType);
	DDX_Control(pDX, IDC_CBTIMESTEPTYPE, m_cboTimeStepType);
	DDX_Control(pDX, IDC_TIMESTEP, m_cboTimeStep);

	DDX_Control(pDX, IDC_BUTTON1, m_btnFont1);
	DDX_Control(pDX, IDC_BUTTON2, m_btnFont2);
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen f? Nachrichten CAxisDlg 
...
void CAxisDlg::PresetValues()
{
	...
	m_pAxis->GetRange(m_fMin, m_fMax, m_fStep);
...
BOOL CAxisDlg::OnInitDialog() 
{
	...
	m_btnFont1.SetTheme(xtpControlThemeOfficeXP);
	m_btnFont2.SetTheme(xtpControlThemeOfficeXP);
	
	m_SpinMarkerSize.SetTheme(xtpControlThemeOfficeXP);
	m_SpinArcSize.SetTheme(xtpControlThemeOfficeXP);
	m_SpinTickSize.SetTheme(xtpControlThemeOfficeXP);
//	m_GridColor.SetTheme(xtpControlThemeOfficeXP);
//	m_Color.SetTheme(xtpControlThemeOfficeXP);
	m_SpinPrecision.SetTheme(xtpControlThemeOfficeXP);

	m_edtName.SetTheme(xtpControlThemeOfficeXP);
	m_chkAutoScale.SetTheme(xtpControlThemeOfficeXP);
	m_edtMin.SetTheme(xtpControlThemeOfficeXP);
	m_edtMax.SetTheme(xtpControlThemeOfficeXP);
	m_chkShowGrid.SetTheme(xtpControlThemeOfficeXP);
	m_chkTimeAxis.SetTheme(xtpControlThemeOfficeXP);
	m_chkVisible.SetTheme(xtpControlThemeOfficeXP);
	m_edtPrecision.SetTheme(xtpControlThemeOfficeXP);
	m_edtArcSize.SetTheme(xtpControlThemeOfficeXP);
	m_edtTickSize.SetTheme(xtpControlThemeOfficeXP);
	m_edtMarkerSize.SetTheme(xtpControlThemeOfficeXP);
	m_edtStep.SetTheme(xtpControlThemeOfficeXP);
	m_chkShowMarker.SetTheme(xtpControlThemeOfficeXP);
	m_cboPlacement.SetTheme(xtpControlThemeOfficeXP);
	m_cboGridType.SetTheme(xtpControlThemeOfficeXP);
	m_cboTimeStepType.SetTheme(xtpControlThemeOfficeXP);
	m_cboTimeStep.SetTheme(xtpControlThemeOfficeXP);
...
void CAxisDlg::OnApply() 
{
	...
	if (!m_bTimeAxis)
	{
		...
		m_pAxis->GetRange(fCurMin, fCurMax, fCurStep);
