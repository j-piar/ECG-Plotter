...
void DrawRectGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
//	CPenSelector   ps(0L, 1, pDC);
//	CBrushSelector bs(color, pDC);
//	pDC->Rectangle(point.x, point.y, point.x + nSize, point.y + nSize);
	SolidBrush brush(GetGDIPlusColor(color));
	graphics.FillRectangle(&brush,RectF(point.x,point.y,nSize,nSize));
}

void DrawCircleGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
	SolidBrush brush(GetGDIPlusColor(color));
	graphics.FillEllipse(&brush,RectF(point.x,point.y,nSize,nSize));
//	CPenSelector   ps(0L, 1, pDC);
//	CBrushSelector bs(color, pDC);
//	pDC->Ellipse(point.x , point.y, point.x + nSize, point.y + nSize);
}

void DrawCrossGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
/*	CPenSelector   ps(color, 2, pDC);
	pDC->MoveTo(point);
	pDC->LineTo(point.x + nSize, point.y + nSize);
	pDC->MoveTo(point.x + nSize, point.y);
	pDC->LineTo(point.x, point.y + nSize); */
	Pen pen(GetGDIPlusColor(color),2);
	graphics.DrawLine(&pen,point.x,point.y,point.x+nSize,point.y+nSize);
	graphics.DrawLine(&pen,point.x + nSize,point.y,point.x,point.y+nSize);
}



void DrawRhombusGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
//	CPenSelector   ps(0L, 1, pDC);
//	CBrushSelector bs(color, pDC);
...
void DrawLeftTriangleGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
//	CPenSelector   ps(0L, 1, pDC);
...
void DrawUpTriangleGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
//	CPenSelector   ps(0L, 1, pDC);
//	CBrushSelector bs(/*pDC->m_bMono ? 0L :*/ color, pDC);
	SolidBrush brush(GetGDIPlusColor(color));
...
void DrawRightTriangleGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
//	CPenSelector   ps(0L, 1, pDC);
//	CBrushSelector bs(/*pDC->m_bMono ? 0L :*/ color, pDC);
	SolidBrush brush(GetGDIPlusColor(color));
...
void DrawDownTriangleGDI(CPoint point, int nSize, COLORREF color, bool bInvert,Graphics& graphics)
{
//	CPenSelector   ps(0L, 1, pDC);
//	CBrushSelector bs(color, pDC);
	SolidBrush brush(GetGDIPlusColor(color));
